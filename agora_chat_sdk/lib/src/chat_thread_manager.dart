...
class ChatThreadManager {
  ...
  static const MethodChannel _channel = const MethodChannel(
    '$_channelPrefix/chat_thread_manager',
    JSONMethodCodec(),
  );
  ...
  /// ~end
  Future<ChatThread?> fetchChatThread({required String chatThreadId}) async {
  ...
  Future<ChatCursorResult<ChatThread>> fetchJoinedChatThreads({
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.fetchJoinedChatThreads,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<ChatCursorResult<ChatThread>> fetchChatThreadsWithParentId({
    ...
    Map req = {"parentId": parentId, "pageSize": limit};
    req.putIfNotNull("cursor", cursor);
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.fetchChatThreadsWithParentId,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<ChatCursorResult<ChatThread>> fetchJoinedChatThreadsWithParentId({
    ...
    req.putIfNotNull("cursor", cursor);
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.fetchJoinedChatThreadsWithParentId,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<ChatCursorResult<String>> fetchChatThreadMembers({
    ...
    Map req = {"pageSize": limit, "threadId": chatThreadId};
    req.putIfNotNull("cursor", cursor);
    Map result = await _channel.invokeMethod(
  ...
  Future<Map<String, ChatMessage>> fetchLatestMessageWithChatThreads({
    ...
    Map req = {"threadIds": chatThreadIds};
    Map result = await _channel.invokeMethod(
  ...
  Future<void> removeMemberFromChatThread({
    ...
    Map req = {"memberId": memberId, "threadId": chatThreadId};
    Map result = await _channel.invokeMethod(
  ...
  Future<void> updateChatThreadName({
    ...
    Map req = {"name": newName, "threadId": chatThreadId};
    Map result = await _channel.invokeMethod(
  ...
  Future<ChatThread> createChatThread({
    ...
    Map req = {"name": name, "messageId": messageId, "parentId": parentId};
    Map result = await _channel.invokeMethod(
  ...
  /// **Throws** 如果有异常会在此抛出，包括错误码和错误信息，详见 [ChatError]。
  /// ~end
  Future<ChatThread> joinChatThread({required String chatThreadId}) async {
    Map req = {"threadId": chatThreadId};
    Map result = await _channel.invokeMethod(
  ...
  /// **Throws** 如果有异常会在此抛出，包括错误码和错误信息，详见 [ChatError]。
  /// ~end
  Future<void> leaveChatThread({required String chatThreadId}) async {
    Map req = {"threadId": chatThreadId};
    Map result = await _channel.invokeMethod(
  ...
  /// **Throws** 如果有异常会在此抛出，包括错误码和错误信息，详见 [ChatError]。
  /// ~end
  Future<void> destroyChatThread({required String chatThreadId}) async {
    Map req = {"threadId": chatThreadId};
    Map result = await _channel.invokeMethod(
  ...
  Future<void> _onChatThreadUserRemoved(Map? event) async {
    ...
    _eventHandlesMap.values.forEach((element) {
      element.onUserKickOutOfChatThread?.call(ChatThreadEvent.fromJson(event));
    });
  }
}
