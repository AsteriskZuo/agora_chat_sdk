...
class ChatProgressManager {
  ...
  Future<void> _onSuccess(Map map) async {
    ...
    ChatClient.getInstance.groupManager.downloadCallback?.onSuccess?.call(
      fileId,
      path,
    );
  }
  ...
  Future<void>? _onProgress(Map map) async {
    ...
    ChatClient.getInstance.groupManager.downloadCallback?.onProgress?.call(
      fileId,
      progress,
    );
  }
  ...
  Future<void>? _onError(Map map) async {
    ...
    ChatClient.getInstance.groupManager.downloadCallback?.onError?.call(
      fileId,
      err,
    );
  }
