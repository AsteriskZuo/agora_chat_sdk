...
class ChatRoomManager {
  ...
  static const MethodChannel _channel = const MethodChannel(
    '$_channelPrefix/chat_room_manager',
    JSONMethodCodec(),
  );
  ...
  Future<ChatRoom?> getChatRoomWithId(String roomId) async {
    Map result = await _channel.invokeMethod(ChatMethodKeys.getChatRoom, {
      "roomId": roomId,
    });
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> destroyChatRoom(String roomId) async {
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.destroyChatRoom,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> changeChatRoomName(String roomId, String name) async {
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.changeChatRoomSubject,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> changeChatRoomDescription(
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.changeChatRoomDescription,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<ChatCursorResult<String>> fetchChatRoomMembers(
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.fetchChatRoomMembers,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> muteChatRoomMembers(
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.muteChatRoomMembers,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> unMuteChatRoomMembers(
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.unMuteChatRoomMembers,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> changeOwner(String roomId, String newOwner) async {
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.changeChatRoomOwner,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> addChatRoomAdmin(String roomId, String admin) async {
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.addChatRoomAdmin,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> removeChatRoomAdmin(String roomId, String admin) async {
    Map req = {"roomId": roomId, "admin": admin};
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.removeChatRoomAdmin,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<List<String>> fetchChatRoomMuteList(
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.fetchChatRoomMuteList,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> removeChatRoomMembers(
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.removeChatRoomMembers,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> blockChatRoomMembers(String roomId, List<String> members) async {
    Map req = {"roomId": roomId, "members": members};
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.blockChatRoomMembers,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> unBlockChatRoomMembers(
    ...
    Map req = {"roomId": roomId, "members": members};
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.unBlockChatRoomMembers,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<List<String>> fetchChatRoomBlockList(
    ...
    Map req = {"roomId": roomId, "pageNum": pageNum, "pageSize": pageSize};
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.fetchChatRoomBlockList,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> updateChatRoomAnnouncement(
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.updateChatRoomAnnouncement,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<String?> fetchChatRoomAnnouncement(String roomId) async {
    Map req = {"roomId": roomId};
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.fetchChatRoomAnnouncement,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
