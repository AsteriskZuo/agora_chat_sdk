...
class ChatGroupManager {
  ...
  static const MethodChannel _channel = const MethodChannel(
    '$_channelPrefix/chat_group_manager',
    JSONMethodCodec(),
  );
  ...
  Future<List<ChatGroup>> fetchJoinedGroupsFromServer({
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.getJoinedGroupsFromServer,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
      List<ChatGroup> list = [];
      result[ChatMethodKeys.getJoinedGroupsFromServer]?.forEach(
        (element) => list.add(ChatGroup.fromJson(element)),
      );
      return list;
    } on ChatError catch (e) {
  ...
  Future<ChatCursorResult<ChatGroupInfo>> fetchPublicGroupsFromServer({
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.getPublicGroupsFromServer,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<ChatGroup> fetchGroupInfoFromServer(
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.getGroupSpecificationFromServer,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<List<String>> fetchBlockListFromServer(
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.getGroupBlockListFromServer,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<Map<String, int>> fetchMuteListFromServer(
    ...
    Map req = {'groupId': groupId, 'pageNum': pageNum, 'pageSize': pageSize};
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.getGroupMuteListFromServer,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<List<String>> fetchAllowListFromServer(String groupId) async {
    Map req = {'groupId': groupId};
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.getGroupWhiteListFromServer,
      req,
    );
    try {
      List<String> list = [];
  ...
  Future<bool> isMemberInAllowListFromServer(String groupId) async {
    Map req = {'groupId': groupId};
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.isMemberInWhiteListFromServer,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<List<ChatGroupSharedFile>> fetchGroupFileListFromServer(
    ...
    Map req = {'groupId': groupId, 'pageNum': pageNum, 'pageSize': pageSize};
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.getGroupFileListFromServer,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<String?> fetchAnnouncementFromServer(String groupId) async {
    Map req = {'groupId': groupId};
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.getGroupAnnouncementFromServer,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> inviterUser(
    ...
    Map result = await _channel.invokeMethod(ChatMethodKeys.inviterUser, req);
  ...
  Future<void> changeGroupName(String groupId, String name) async {
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.updateGroupSubject,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> changeGroupDescription(String groupId, String desc) async {
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.updateDescription,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> unMuteAllMembers(String groupId) async {
    Map req = {'groupId': groupId};
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.unMuteAllMembers,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> removeAllowList(String groupId, List<String> members) async {
    Map req = {'groupId': groupId, 'members': members};
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.removeWhiteList,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> uploadGroupSharedFile(String groupId, String filePath) async {
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.uploadGroupSharedFile,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> downloadGroupSharedFile({
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.downloadGroupSharedFile,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> removeGroupSharedFile(String groupId, String fileId) async {
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.removeGroupSharedFile,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> updateGroupAnnouncement(
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.updateGroupAnnouncement,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> joinPublicGroup(String groupId) async {
    Map req = {'groupId': groupId};
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.joinPublicGroup,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> requestToJoinPublicGroup(
    ...
    req.putIfNotNull('reason', reason);
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.requestToJoinPublicGroup,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> acceptJoinApplication(String groupId, String username) async {
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.acceptJoinApplication,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> declineJoinApplication(
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.declineJoinApplication,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<ChatGroup> acceptInvitation(String groupId, String inviter) async {
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.acceptInvitationFromGroup,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> declineInvitation({
    ...
    req.putIfNotNull('reason', reason);
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.declineInvitationFromGroup,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<void> setMemberAttributes({
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.setMemberAttributesFromGroup,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<Map<String, String>> fetchMemberAttributes({
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.fetchMemberAttributesFromGroup,
      req,
    );
    try {
      ChatError.hasErrorFromResult(result);
  ...
  Future<int> fetchJoinedGroupCount() async {
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.fetchJoinedGroupCount,
    );
    try {
      ChatError.hasErrorFromResult(result);
    ...
    _eventHandlesMap.values.forEach((element) {
      switch (type) {
        ...
        case ChatGroupChangeEvent.ON_ATTRIBUTES_CHANGED_OF_MEMBER:
          ...
          Map<String, String>? attributes = map["attributes"]
              .cast<String, String>();
