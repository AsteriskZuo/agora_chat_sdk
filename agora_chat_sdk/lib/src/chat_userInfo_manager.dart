...
class ChatUserInfoManager {
  ...
  static const MethodChannel _channel = const MethodChannel(
    '$_channelPrefix/chat_userInfo_manager',
    JSONMethodCodec(),
  );
  ...
  Future<ChatUserInfo> updateUserInfo({
    ...
    try {
      Map result = await _channel.invokeMethod(
        ChatMethodKeys.updateOwnUserInfo,
        req,
      );
      ChatError.hasErrorFromResult(result);
      ChatUserInfo info = ChatUserInfo.fromJson(
        result[ChatMethodKeys.updateOwnUserInfo],
      );
  ...
  Future<Map<String, ChatUserInfo>> fetchUserInfoById(
    ...
    Map result = await _channel.invokeMethod(
      ChatMethodKeys.fetchUserInfoById,
      req,
    );
